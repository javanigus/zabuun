...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > His New Laptop</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>His New Laptop</h1>
				<p>  He has a new laptop. He goes online every day. He reads his email. He replies to his email. He visits different web sites. He reads the news online. He reads the sports. He checks the weather. He watches TV programs. He makes travel plans. He loves his new laptop.  </p>
				<!-- end essay -->
			</div>
		</div>
