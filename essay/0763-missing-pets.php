...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Missing Pets</p>
				...
				<!-- begin essay -->
				<h1>Missing Pets</h1>
				<p> "I don't think all these animals are running away," though Kenneth. Then, Kenneth saw something that broke his heart. There was a trail of blood on the floor. It led to the mountain side. A coyote must be taking all the small pets in the night.  </p>
				<!-- end essay -->
			</div>
		</div>
