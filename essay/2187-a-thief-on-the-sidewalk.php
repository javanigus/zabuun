...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > A Thief on the Sidewalk</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>A Thief on the Sidewalk</h1>
				<p>  "I'm sorry," said the officer. "That's not against the law. If you see him actually steal something, give us a call."  </p>
				<!-- end essay -->
			</div>
		</div>
