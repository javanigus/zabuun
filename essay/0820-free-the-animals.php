...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Free the Animals</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Free the Animals</h1>
				<p> Suddenly, Henry heard a lot of people yelling. Mario then came running proudly. "Don't worry, Dad!" he said. "I opened the sad lion's door."  </p>
				<!-- end essay -->
			</div>
		</div>
