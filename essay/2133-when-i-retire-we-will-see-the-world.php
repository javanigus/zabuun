...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > When I Retire, We Will See the World</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>When I Retire, We Will See the World</h1>
				<p>  Maybe an hour later, the phone rang. He picked it up on the fifth ring. It was Bob, wondering if Fritz was going to play poker later that night. </p>
				<!-- end essay -->
			</div>
		</div>
