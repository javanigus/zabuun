...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > TSA's New Policy (1)</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>TSA's New Policy (1)</h1>
				<p> Cher told Brooke that she would not be allowed to board her plane. Brooke started crying. Her boyfriend in Atlanta was going to be very disappointed. </p>
				<!-- end essay -->
			</div>
		</div>
