...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > English Skills</p>
				...
				<p>  Donald is in the second grade. His reading level is not as good as the other students'. He wants to improve his English skills. He starts to read more. He looks up words he does not know in the dictionary. He writes down what the words mean. Afterwards, he reads the book again.  </p>
				<!-- end essay -->
			</div>
		</div>
