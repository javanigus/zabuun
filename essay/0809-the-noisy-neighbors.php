...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > The Noisy Neighbors</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>The Noisy Neighbors</h1>
				<p> Luckily, these neighbors soon moved out. Jack couldn't be happier. He would finally enjoy peace and quiet. Unfortunately, the new neighbors arrived with a baby. This baby cried just as loud as all the other things put together.  </p>
				<!-- end essay -->
			</div>
		</div>
