...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Don't Top Off the Tanks</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Don't Top Off the Tanks</h1>
				<p> "People have no idea how little AA cares about their safety," Rogers said. "Saving fuel is more important to management than saving lives." </p>
				<!-- end essay -->
			</div>
		</div>
