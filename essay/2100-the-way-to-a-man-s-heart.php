...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > The Way to a Man's Heart</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>The Way to a Man's Heart</h1>
				<p> Lina watched contentedly as Luke devoured the cheesecake and ice cream. Someday, she thought, I will be his dessert.  </p>
				<!-- end essay -->
			</div>
		</div>
