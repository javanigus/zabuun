...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Vacation Time</p>
				...
				<!-- begin essay -->
				<h1>Vacation Time</h1>
				<p>Even when U.S. workers do have time off, many are afraid to take it because they worry they may be seen as non-productive workers and lose their job. Other workers worry about going on vacation and having a mountain of work when they return.</p>
				<!-- end essay -->
			</div>
		</div>
