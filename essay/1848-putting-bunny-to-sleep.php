...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Putting Bunny to Sleep</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Putting Bunny to Sleep</h1>
				<p> Jim and Alicia both arrived at the same conclusion without very much discussion. When they took Bunny to the vet so that she could be put to sleep, Bugs went, too. </p>
				<!-- end essay -->
			</div>
		</div>
