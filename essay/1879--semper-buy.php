...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > "Semper Buy"</p>
				...
				<!-- begin essay -->
				<h1>"Semper Buy"</h1>
				<p> "We are always eager and happy to show that we take care of our own," said the broadly smiling Chertoff as he presented Reid the medal in front of TV news cameras. "Thank you so much for your service to your country." </p>
				<!-- end essay -->
			</div>
		</div>
