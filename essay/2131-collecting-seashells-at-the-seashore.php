...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Collecting Seashells at the Seashore</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Collecting Seashells at the Seashore</h1>
				<p> "Oh, please," said Lisa. "You eat so little. Ounces don't turn into pounds. How about Zuma Beach? That's pretty far north of Santa Monica Beach, so it's just right—not too crowded and not too empty."  </p>
				<!-- end essay -->
			</div>
		</div>
