...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Police Arrest Happy Van Driver</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Police Arrest Happy Van Driver</h1>
				<p> The officer brought out his handcuffs. Karl's grin disappeared. "Hey, at least let me have one more hit!"  </p>
				<!-- end essay -->
			</div>
		</div>
