...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > The Wedding Gift (1)</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>The Wedding Gift (1)</h1>
				<p> "Maybe my envelope looked too thin, and some thief thought Walt's envelope looked nice and fat." </p>
				<!-- end essay -->
			</div>
		</div>
