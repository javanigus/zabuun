...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > The Cool Grandpa</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>The Cool Grandpa</h1>
				<p> The kids would meet at his grave every Sunday afternoon. This went on for many years. They would sit around and tell old jokes. They always brought ice cream.  </p>
				<!-- end essay -->
			</div>
		</div>
