...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > The Pile of Paper</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>The Pile of Paper</h1>
				<p> Sammy gathered the pile into his arms and trudged back upstairs. Pleased that he still had not dropped any paper, he lowered the pile back onto the floor. Then he stood up, but just a little bit too fast.  </p>
				<!-- end essay -->
			</div>
		</div>
