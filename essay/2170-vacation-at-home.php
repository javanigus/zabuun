...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Vacation at Home</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Vacation at Home</h1>
				<p> Between articles, he took breaks by watching the nearby traffic and pedestrians. The coffee shop was next to a huge parking lot. The lot was for customers of a grocery store, movie rental store, pharmacy, bank, and restaurant. Kevin considered his outdoor seat the perfect place for one of his favorite activities—people watching.</p>
				<!-- end essay -->
			</div>
		</div>
