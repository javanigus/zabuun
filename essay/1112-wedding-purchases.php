...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Wedding Purchases</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Wedding Purchases</h1>
				<p>  There is a wedding. The wedding is next month. He buys a new suit for himself. The suit costs $400. It is a dark blue suit. He buys a gift for the bride. He buys an iPad for her. He buys a gift for the groom. He buys a tennis racket for him.  </p>
				<!-- end essay -->
			</div>
		</div>
