...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Another Jealous Girlfriend</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Another Jealous Girlfriend</h1>
				<p> She can recognize a dying plant but not a dead love affair, Scott grumbled as he rolled out of bed. </p>
				<!-- end essay -->
			</div>
		</div>
