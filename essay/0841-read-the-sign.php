...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Read the Sign</p>
				...
				<!-- begin essay -->
				<h1>Read the Sign</h1>
				<p> Justin decided to ignore the sign. He had been looking forward to swimming all week. The big waves looked fun. "Come in, guys!" said Justin. He jumped in. Then a huge wave took him under. His friends ran to find a lifeguard. The lifeguard had to rescue Justin. "Can't you read?" he yelled.  </p>
				<!-- end essay -->
			</div>
		</div>
