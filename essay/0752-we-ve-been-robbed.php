...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > We've Been Robbed</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>We've Been Robbed</h1>
				<p> Mr. Smith started cleaning the mess. He saw something lying by the window sill. It was a wallet. The burglar had dropped it while jumping through the window.  </p>
				<!-- end essay -->
			</div>
		</div>
