...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Take This Job and Shove It</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Take This Job and Shove It</h1>
				<p> "Anywhere but this dump!" Maxwell said angrily, as he stood up and walked out.  </p>
				<!-- end essay -->
			</div>
		</div>
