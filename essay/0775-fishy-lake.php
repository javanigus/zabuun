...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Fishy Lake</p>
				...
				<!-- begin essay -->
				<h1>Fishy Lake</h1>
				<p> There is a factory about a mile away from the lake. Mrs. Wright suspects they are responsible for the changes. "They're probably dumping their waste in the water," she says. "That's probably killing all the fish." They probably won't eat the fish they catch there anymore.  </p>
				<!-- end essay -->
			</div>
		</div>
