...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Death Is Part of Life</p>
				...
				<p> Much of that time spent waiting would also be spent in thought. What do people think about when they know their time is almost up, Joel wondered. </p>
				<!-- end essay -->
			</div>
		</div>
