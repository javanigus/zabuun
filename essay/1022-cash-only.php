...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Cash Only</p>
				...
				<!-- begin essay -->
				<h1>Cash Only</h1>
				<p> Eduardo first called his sister to help him. His sister was at work, so she couldn't come until night time. Eduardo called his best friend Mason. Mason was in the area, so he said okay. Mason came down and paid for Eduardo's meal.</p>
				<!-- end essay -->
			</div>
		</div>
