...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Camping</p>
				...
				<!-- begin essay -->
				<h1>Camping</h1>
				<p>When people go camping they often do other outdoor activities like fishing, canoeing, hiking, kayaking, swimming, horseback riding and mountain biking.</p>
				<!-- end essay -->
			</div>
		</div>
