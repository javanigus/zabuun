...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Airplanes Are Safer Than Cars</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Airplanes Are Safer Than Cars</h1>
				<p> Donald ignored his friend. He was going to drive for three days. Halfway through the trip, Donald got very sleepy. He was on a highway. He crashed into a giant trailer.  </p>
				<!-- end essay -->
			</div>
		</div>
