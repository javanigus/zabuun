...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Check Your Bags at the Store Entrance</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Check Your Bags at the Store Entrance</h1>
				<p>  By this time, Adrian had calmed down. He didn't really want the employee to lose her job. He told the representative to forget about it.  </p>
				<!-- end essay -->
			</div>
		</div>
