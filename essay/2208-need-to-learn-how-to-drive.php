...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Need to Learn How to Drive</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Need to Learn How to Drive</h1>
				<p>After a while, her friends were tired of giving Meryl rides everywhere. "You need to learn how to drive, Meryl," they told her. She knew they were right, but Meryl was scared.</p>
				<!-- end essay -->
			</div>
		</div>
