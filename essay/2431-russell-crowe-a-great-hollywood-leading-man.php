...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Russell Crowe: A Great Hollywood Leading Man</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Russell Crowe: A Great Hollywood Leading Man</h1>
				<p>Crowe has been generous with his fortune. He has donated money to several causes in his home country of New Zealand, Australia, and in the United States.</p>
				<!-- end essay -->
			</div>
		</div>
