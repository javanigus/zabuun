...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Central Park</p>
				...
				<!-- begin essay -->
				<h1>Central Park</h1>
				<p>The park is not dead in the winter. When it snows, families often go to sled or to go ice-skating in an outdoor rink owned by Donald Trump.</p>
				<!-- end essay -->
			</div>
		</div>
