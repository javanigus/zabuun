...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Donating Clothes</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Donating Clothes</h1>
				<p> Carrie ignored them. She took pictures of her clothes. She posted them on a website. Two weeks passed by. Her friends were right. No one wanted to buy her clothes. Carrie decided to donate them.</p>
				<!-- end essay -->
			</div>
		</div>
