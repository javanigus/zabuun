...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Tenants Watch Building Burn</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Tenants Watch Building Burn</h1>
				<p> Firemen discovered a charred gasoline can in the attic. This was the second suspicious apartment fire in a month.  </p>
				<!-- end essay -->
			</div>
		</div>
