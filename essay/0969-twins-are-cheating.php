...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Twins Are Cheating</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Twins Are Cheating</h1>
				<p> Annie and Diana no longer pretend to be each other anymore. After they got Fs, their parents forced them to move schools. The two schools were not that far apart, so they still got to see each other.</p>
				<!-- end essay -->
			</div>
		</div>
