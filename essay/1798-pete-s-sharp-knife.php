...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Pete's Sharp Knife</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Pete's Sharp Knife</h1>
				<p> No kidding, Pete thought. He was so careful that he didn't use the knife for almost a year. </p>
				<!-- end essay -->
			</div>
		</div>
