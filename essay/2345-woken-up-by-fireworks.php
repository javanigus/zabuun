...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Woken up by Fireworks</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Woken up by Fireworks</h1>
				<p>Betty tried to go back to sleep, but the loud booms and crackles kept going. She decided to get a glass of water and go out into the yard to see the fireworks.</p>
				<!-- end essay -->
			</div>
		</div>
