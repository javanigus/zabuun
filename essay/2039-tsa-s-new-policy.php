...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > TSA's New Policy (2)</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>TSA's New Policy (2)</h1>
				<p> "This is a victory for TSA," announced a TSA spokesman. "It allows us to focus on life and death issues rather than waste our valuable time waiting for travelers to remove all their jewelry." </p>
				<!-- end essay -->
			</div>
		</div>
