...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Bank Robbery</p>
				...
				<!-- begin essay -->
				<h1>Bank Robbery</h1>
				<p> The police chuckled. The bank employees returned to work. The bank customers returned to their lines. The bank robber, hopefully, would never return. </p>
				<!-- end essay -->
			</div>
		</div>
