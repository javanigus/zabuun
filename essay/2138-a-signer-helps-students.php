...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > A Signer Helps Students</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>A Signer Helps Students</h1>
				<p> What then? Then she will leave California, move to Paris, find a romantic French boyfriend, and live happily ever after. That's her plan. </p>
				<!-- end essay -->
			</div>
		</div>
