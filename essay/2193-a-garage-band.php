...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > A Garage Band</p>
				...
				<!-- begin essay -->
				<h1>A Garage Band</h1>
				<p>Many American Rock ‘N' Roll bands began their journey in someone's garage. One notable group to start this way was Van Halen. David and his friends were convinced they could become the next Beatles with a little luck and a lot of practice</p>
				<!-- end essay -->
			</div>
		</div>
