...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > The Breakup</p>
				...
				<!-- begin essay -->
				<h1>The Breakup</h1>
				<p> "I needed you that weekend. Instead, you preferred to play golf. Now there is a shadow on my heart that nothing can remove," she told him sadly.   </p>
				<!-- end essay -->
			</div>
		</div>
