...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Let's Go to Vegas!</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Let's Go to Vegas!</h1>
				<p> A few minutes later, Janice called back. She had a big problem—a schedule conflict. She had already promised to attend her daughter's eighth-grade graduation ceremony this very weekend. </p>
				<!-- end essay -->
			</div>
		</div>
