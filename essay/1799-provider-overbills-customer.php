...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Provider Overbills Customer</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Provider Overbills Customer</h1>
				<p> We'll see about this, Simon thought, as he searched for Wink's 800 number.   </p>
				<!-- end essay -->
			</div>
		</div>
