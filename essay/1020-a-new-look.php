...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > A New Look</p>
				...
				<!-- begin essay -->
				<h1>A New Look</h1>
				<p> During lunch time, Laura overheard one of the mean girls say that no guy would ever want to date her because of her manly hair cut. Laura was hurt, but she didn't care, because she knew that she cut her hair for a good cause.</p>
				<!-- end essay -->
			</div>
		</div>
