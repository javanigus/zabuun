...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Hollywood Stars and Tourists</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Hollywood Stars and Tourists</h1>
				<p> "I hope they leave him in jail," said a tourist, who saw the whole incident. "That guy's an idiot." </p>
				<!-- end essay -->
			</div>
		</div>
