...
<html class="no-js" lang="">
	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				<div class="location">
					<p class="breadcrumbs">Essays > Going to the Dentist</p>
					<p class="expandcollapse">
						<a href="">Expand All</a> | <a href="">Collapse All</a>
					</p>
				</div>
				<!-- begin essay -->
				<h1>Going to the Dentist</h1>
				<p> It took 20 minutes to get Adrian to sit on the dentist chair. However, Adrian doesn't remember anything after that. He had slept through his entire appointment. He then pretended not to remember crying the whole way to the clinic.  </p>
				<!-- end essay -->
			</div>
		</div>
