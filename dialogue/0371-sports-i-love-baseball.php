	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				...
				<!-- begin dialogue -->
				<h1>Sports</h1>
				<h2>I Love Baseball</h2>
				<p>  <b>A:</b> Baseball is fun.<br> <b>B:</b> I like to hit the ball.<br> <b>A:</b> I like to run around the bases.<br> <b>B:</b> I like to slide into the bases.<br> <b>A:</b> Yeah. It’s a lot of fun to slide</p>
				<!-- end dialogue -->
			</div>
		</div>
