	...
	<body>
		...
		<div class="content">
			...
			<div class="main">
				...
				<!-- begin dialogue -->
				<h1>Shopping</h1>
				<h2>Looking for a Perfect Gift (2)</h2>
				   <b>A:</b> Can you help me pick out a gift for my niece?<br> <b>B:</b> Most normal little girls go wild over Barbie dolls.<br> <b>A:</b> That sounds good. Let me see one.<br> <b>B:</b> Here's the latest model—Digital Barbie
				<!-- end dialogue -->
			</div>
		</div>
